...
const Search = () => {
  return (
    <div className='flex w-screen md:max-w-max gap-5 justify-center items-center py-[5px] px-4 md:py-[6px] md:px-5 md:pr-1 rounded-full shadow-md border-[1px] md:absolute md:left-12 lg:static lg:ml-32 lg:py-2'>
